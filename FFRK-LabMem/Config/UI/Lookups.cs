...
namespace FFRK_LabMem.Config.UI
{
    class Lookups
    {
        ...
        public static Dictionary<String, String> Paintings = new() {
        ...
        public static Dictionary<String, String> Treasures = new() {
            {"5", "Hero Equipment"},
        ...
        public static BindingList<AdbHostItem> AdbHosts = new() {
        ...
        public static Dictionary<String, String> Timings = new() {
        ...
        public static Dictionary<String, String> Blocklist = new() {
        ...
        public static Dictionary<String, String> Counters = new() {
        ...
        public static Dictionary<Counters.DropCategory, String> DropCategories = new() {
        ...
        public static Dictionary<Notifications.EventType, String> NotificationEvents = new() {
