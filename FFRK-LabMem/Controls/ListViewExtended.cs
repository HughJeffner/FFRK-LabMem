...
namespace FFRK_LabMem.Controls
{
    public class ListViewExtended : ListView
    {
        ...
        private static void setGrpState(ListViewGroup lstvwgrp, ListViewGroupState state)
        {
            ...
            else
            {
                ...
                if (GrpId != null)
                {
                    ...
                    MarshalSendMessage(lstvwgrp, group, GrpId);
                }
                else
                {
        ...
        protected static void MarshalSendMessage(ListViewGroup lstvwgrp, LVGROUP group, int? GrpId)
        {
            IntPtr ip = IntPtr.Zero;
            try
            {
